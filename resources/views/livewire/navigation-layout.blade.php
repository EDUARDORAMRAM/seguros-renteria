            ...
            <ul class="space-y-2 font-medium px-3">
                ...
                <li>
                    <a href="{{ route('reportes.ventas') }}" 
                       class="flex items-center px-2 py-2 rounded-lg group {{ request()->routeIs('reportes.ventas') ? 'bg-blue-50 text-blue-600' : 'text-gray-900 hover:bg-gray-100' }}">
                        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('reportes.ventas') ? 'text-blue-600' : 'text-gray-500 group-hover:text-blue-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
