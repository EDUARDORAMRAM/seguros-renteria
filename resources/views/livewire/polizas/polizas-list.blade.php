                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($polizas as $poliza)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                @if($poliza->unidad)
                                    <span class="font-medium">{{ $poliza->unidad->Marca }}</span>
                                    <span class="text-gray-400 text-xs">{{ $poliza->unidad->Submarca }}</span>
                                    <span class="text-gray-400 text-xs block">{{ $poliza->unidad->Modelo }} {{ $poliza->unidad->Ano }}</span>
                                @else
